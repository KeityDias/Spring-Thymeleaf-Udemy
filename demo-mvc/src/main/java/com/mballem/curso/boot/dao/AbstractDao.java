...
public abstract class AbstractDao<T, PK extends Serializable> {
	...
	/**
	 * Protegido para não ser acessado fora das classes de Dao que implementam a classe AbstractDao;
	 * @return
	 */
	...
	public List<T> findAll() {
		...
		return entityManager
				.createQuery("from " + entityClass.getSimpleName(), entityClass)//Retorna o nome da entidade em que será realizada a consulta;
				.getResultList();
	}	
	/*
